...
class Tracer:
    ...
    def firstName(self):
        self.FIRST_NAME = tkinter.Label(self.user_info_frame_label, text="First Name", highlightbackground= "dark blue", highlightthickness= 2)
        self.FIRST_NAME.grid(row=1, column=0, padx= 10, pady= 5)
        self.FIRST_NAME_INPUT = tkinter.Entry(self.user_info_frame_label)
        self.FIRST_NAME_INPUT.grid(row=1, column=1)
        
        #last name label and entry
    def lastName(self):
        self.LAST_NAME = tkinter.Label(self.user_info_frame_label, text="Last Name", highlightbackground= "dark blue", highlightthickness= 2)
        self.LAST_NAME.grid(row=2, column=0, padx= 10, pady= 5)
        self.LAST_NAME_INPUT = tkinter.Entry(self.user_info_frame_label)
        self.LAST_NAME_INPUT.grid(row=2, column=1)

    #Gender label and entry
    def gender(self):
        self.GENDER = tkinter.Label(self.user_info_frame_label, text="Gender", highlightbackground= "dark blue", highlightthickness= 2)
        self.GENDER.grid(row=3, column=0, padx= 10, pady= 5)
        self.GENDER_INPUT = ttk.Combobox(self.user_info_frame_label,values=["Male", "Female", "Transgender Male", "Transgender Female", "Prefer Not to Say"])
        self.GENDER_INPUT.grid(row=3, column=1)

    
    #Age label and entry
    def age(self):
        self.AGE = tkinter.Label(self.user_info_frame_label, text="Age", highlightbackground= "dark blue", highlightthickness= 2)
        self.AGE.grid(row=4, column=0, padx= 10, pady= 5)
        self.AGE_INPUT = tkinter.Spinbox(self.user_info_frame_label, from_=1, to=100)
        self.AGE_INPUT.grid(row=4, column=1)

    #Nationality label and entry
    def national(self):
        #Nationality label and entry
        self.NATIONALITY = tkinter.Label(self.user_info_frame_label, text="Nationality", highlightbackground= "dark blue", highlightthickness= 2)
        self.NATIONALITY.grid(row=4, column=0, padx= 10, pady= 5)
        self.NATIONALITY_INPUT = ttk.Combobox(self.user_info_frame_label, values=["Filipino", "Chinese", "Korean", "American"], highlightbackground= "dark blue", highlightthickness= 2)
    ...
    def vaccination(self):
        ...
        self.VACCINATION_STATUS = tkinter.Label(self.symptoms_frame_label, text="Vaccination Status", highlightbackground= "dark blue", highlightthickness= 2)
        self.VACCINATION_STATUS.grid(row=1, column=0, padx= 10, pady= 5)
        self.VACCINATION_STATUS_INPUT = ttk.Combobox(self.symptoms_frame_label, values= ["Unvaccinated", "1st Dose", "2nd Dose(Fully Vaccinated)", "1st Booster Shot", "2nd Booster Shot"])
        self.VACCINATION_STATUS_INPUT['state'] = 'readonly'
        self.VACCINATION_STATUS_INPUT.grid(row=1, column=1)

    #Phone Number label and entry
    def phone(self):
        self.PHONE = tkinter.Label(self.user_info_frame_label, text= "Cellphone Number", highlightbackground= "dark blue", highlightthickness= 2)
        self.PHONE.grid(row=6, column=0, padx= 10, pady= 5)
        self.PHONE_INPUT = tkinter.Entry(self.user_info_frame_label)
        self.PHONE_INPUT.grid(row=6, column=1)
    
    # address label and entry
    def address(self):
        self.ADDRESS = tkinter.Label(self.user_info_frame_label, text="Address", highlightbackground= "dark blue", highlightthickness= 2)
        self.ADDRESS.grid(row=7, column=0, padx= 10, pady= 5)
    ...
    def accept(self):
        ...
        self.terms_check.grid(row=8, column=1, padx= 4, pady= 5, highlightbackground= "dark blue", highlightthickness= 2)
